...
path_IAPWS95_2MPa = os.path.join(datapath,"dat_IAPWS95_2MPa_10-90-0.5degC")
path_IAPWS95_10MPa = os.path.join(datapath,"dat_IAPWS95_10MPa_10-90-0.5degC")
path_IAPWS95_25MPa = os.path.join(datapath,"dat_IAPWS95_25MPa_10-90-0.5degC")
path_IAPWS95_50MPa = os.path.join(datapath,"dat_IAPWS95_50MPa_10-90-0.5degC")
