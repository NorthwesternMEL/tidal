...
dvs_vi_exact = thexp.deltaVth(pfi, bs, temp, 'exact')*1e2
# Small thermal expansion integration, equation (22) in Coulibaly et al., 2022
dvs_vi_small = thexp.deltaVth(pfi, bs, temp, 'small')*1e2
# Linear thermal expansion formula, equation (11) in Coulibaly et al., 2022
dvs_vi_lin = thexp.deltaVth(pfi, bs, temp, 'linear')*1e2
...
dvw_vi_exact = thexp.deltaVth(ni, bw, temp, 'exact')*1e2
# Small thermal expansion integration, equation (23) in Coulibaly et al., 2022
dvw_vi_small = thexp.deltaVth(ni, bw, temp, 'small')*1e2
# Linear thermal expansion formula, equation (12) in Coulibaly et al., 2022
dvw_vi_lin = thexp.deltaVth(ni, bw, temp, 'linear')*1e2
