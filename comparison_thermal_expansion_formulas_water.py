...
plt.figure(1)
plt.plot(temp, aw_Baldi88*1e4, label="Baldi et al., 1988 (p=1 atm)")
plt.plot(temp, aw_Cekerevac05*1e4, label="Cekerevac et al., 2005 (p=1 atm)")
plt.plot(temp, aw_Smith54*1e4, label="Smith et al., 1954")
plt.plot(temp, aw_Chapman74*1e4, label="Chapman, 1974")
plt.plot(temp, aw_IAPWS95*1e4, label="IAPWS-95 (p=1 atm)")
plt.plot(temp, aw_CRC40ed*1e4, label="CRC Handbook, 40th ed.")
...
np.savetxt("tab_comparison_thermal_expansion_formulas_water.csv",
           np.concatenate((temp[:,np.newaxis], aw_Baldi88[:,np.newaxis],
                           aw_Cekerevac05[:,np.newaxis],
                           aw_Smith54[:,np.newaxis], aw_Chapman74[:,np.newaxis],
                           aw_IAPWS95[:,np.newaxis], aw_CRC40ed[:,np.newaxis]),
                          axis=1),
           header=("temperature_degC,aw_Baldi88_1atm_1perdegC,"+
                   "aw_Cekerevac05_1atm_1perdegC,aw_Smith54_1perdegC,"+
                   "aw_Chapman74_1perdegC,aw_IAPWS95_1atm_1perdegC,"+
                   "aw_CRC40ed_1perdegC"),
           delimiter=',')
...
# Baldi et al., 1988
aw_Baldi88_50kPa = thexp.coef_w_Baldi88(50e3,temp)
aw_Baldi88_200kPa = thexp.coef_w_Baldi88(200e3,temp)
aw_Baldi88_400kPa = thexp.coef_w_Baldi88(400e3,temp)
aw_Baldi88_1000kPa = thexp.coef_w_Baldi88(1000e3,temp)
...
# The coefficients obtained in the variable `aw_IAPWS95_coef` below are used to
# inform the preset 'd3_t20-80_p50-1000' of the fitting function named
# 'coef_w_IAPWS95_fit' in the 'thexp' module
aw_IAPWS95_fit, aw_IAPWS95_coef = thexp.coef_w_IAPWS95_fit('compute', temp,
                                                           aw_IAPWS95_p, 3)

# Plot results and export to comma-separated tables
plt.figure(2)
plt.plot(temp, aw_Baldi88_50kPa*1e4, label="Baldi et al., 1988 (p=50 kPa)")
plt.plot(temp, aw_Baldi88_200kPa*1e4, label="Baldi et al., 1988 (p=200 kPa)")
plt.plot(temp, aw_Baldi88_400kPa*1e4, label="Baldi et al., 1988 (p=400 kPa)")
plt.plot(temp, aw_Baldi88_1000kPa*1e4, label="Baldi et al., 1988 (p=1000 kPa)")
plt.plot(temp, aw_IAPWS95_p[0]*1e4, 'x', label="IAPWS-95 (p=50 kPa)")
plt.plot(temp, aw_IAPWS95_p[1]*1e4, '+', label="IAPWS-95 (p=200 kPa)")
plt.plot(temp, aw_IAPWS95_p[2]*1e4, 's', label="IAPWS-95 (p=400 kPa)")
plt.plot(temp, aw_IAPWS95_p[3]*1e4, 'v', label="IAPWS-95 (p=10000 kPa)")
plt.plot(temp, aw_IAPWS95_fit*1e4, 'k-', label="IAPWS-95 (3rd degree poly fit)")
...
np.savetxt("tab_comparison_pressure_IAPWS95_Baldi88.csv",
           np.concatenate((temp[:,np.newaxis], aw_Baldi88_50kPa[:,np.newaxis],
                           aw_Baldi88_200kPa[:,np.newaxis],
                           aw_Baldi88_400kPa[:,np.newaxis],
                           aw_Baldi88_1000kPa[:,np.newaxis],
                           aw_IAPWS95_p[0][:,np.newaxis],
                           aw_IAPWS95_p[1][:,np.newaxis],
                           aw_IAPWS95_p[2][:,np.newaxis],
                           aw_IAPWS95_p[3][:,np.newaxis],
                           aw_IAPWS95_fit[:,np.newaxis]),
                          axis=1),
           header=("temperature_degC,aw_Baldi88_50kPa_1perdegC,"+
                   "aw_Baldi88_200kPa_1perdegC,aw_Baldi88_400kPa_1perdegC,"+
                   "aw_Baldi88_1000kPa_1perdegC,aw_IAPWS95_50kPa_1perdegC,"+
                   "aw_IAPWS95_200kPa_1perdegC,aw_IAPWS95_400kPa_1perdegC,"+
                   "aw_IAPWS95_1000kPa_1perdegC,"+
                   "aw_IAPWS95_fit_d3_t20-80_p50_1000_1perdegC"),
           delimiter=',')